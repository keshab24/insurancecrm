...
@endsection --}}
@section('title')
<p class="h4 align-center mb-0">{{ $company->name }}</p>
@endsection
            ...
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-hover role-table">
                    ...
                    <tbody id="tablebody">
                        ...
                        @foreach ($company->products as $index => $pro)
                        <tr class="gradeX" id="row_{{ $pro->id }}">
                            ...
                            <td class="justify-content-center">
                                <a href="/productEdit/{{ $pro->id }}" id="{{ $pro->id }}" title="Edit "><button
                                        class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></button></a>&nbsp;
                                <a href='/productList/{{ $pro->id }}' class="delete-discount"

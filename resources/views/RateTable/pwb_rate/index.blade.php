...
@section('footer_js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.xedit').editable({
                url: '{{url("admin/update-rate-table/pwb-rate")}}',
                title: 'Update',
                ajaxOptions: {
                    type: 'post'
                },
...
@endsection
@section('title')
    <p class="h4 align-center mb-0">PWB Rate Table</p>
@endsection
...
@section('dynamicdata')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="collapse" id="collapseBulkImport">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="" action="{{ route('pwb.rates.import') }}" method="POST"
       ...
       <br>
       <hr>
       <form action="{{route('endowment.rate.pwb.index')}}" method="get" class="form-inline">
           {!! csrf_field() !!}
           <div class="">
       ...
       <div class="mx-auto text-center">
           @if($selectedCompany)
               ...
               <br>
               <a href="{{ route('company.pwb.rates.export',(['company_id'=>$selectedCompany->id, 'product_id'=>$selectedProduct->id])) }}"
                  download>
                   <button class="btn btn-info mr-2">Download Pwb Rate Endowment</button>
               </a>
           @endif
       </div>
       @if($columns && $rows)

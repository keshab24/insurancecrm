...
@section('footer_js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.xedit').editable({
                url: '{{url("admin/update-rate-table/term-rider-rate")}}',
                title: 'Update',
                ajaxOptions: {
                    type: 'post'
                },
...
@endsection
@section('title')
    <p class="h4 align-center mb-0">Term Rider Rate Table</p>
@endsection
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseBulkImport"
                ...
                Click To Import Term Rider Rate Data
            </button>
            <div class="collapse" id="collapseBulkImport">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6"><strong>Upload Term Rider Rate File</strong></h5>
                    </div>
                    <div class="card-body">
                        <form class="" action="{{ route('term.rates.import') }}" method="POST"
       ...
       <br>
       <hr>
       <form action="{{route('endowment.rate.term.index')}}" method="get" class="form-inline">
           {!! csrf_field() !!}
           <div class="">
       ...
       <div class="mx-auto text-center">
           @if($selectedCompany)
               ...
               <br>
               <a href="{{ route('company.term.rates.export',(['company_id'=>$selectedCompany->id, 'product_id'=>$selectedProduct->id])) }}"
                  download>
                   <button class="btn btn-info mr-2">Download Term Rider Rate Endowment</button>
               </a>
           @endif
       </div>
       @if($columns && $rows)
           <div style="overflow-x:auto;">
               ...
               @include('RateTable.term_rider.table')
           </div>
       @else

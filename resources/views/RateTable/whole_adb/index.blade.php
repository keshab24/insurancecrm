...
@section('footer_js')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.xedit').editable({
                url: '{{url("admin/update-rate-table/adb-rate")}}',
                title: 'Update',
                ajaxOptions: {
                    type: 'post'
                },
...
@endsection
@section('title')
    <p class="h4 align-center mb-0">ADB Rate Table</p>
@endsection
...
@section('dynamicdata')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="collapse" id="collapseBulkImport">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6"><strong>Upload ADB Rate File</strong></h5>
                    </div>
                    <div class="card-body">
                        <form class="" action="{{ route('adb.rates.import') }}" method="POST"
                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-group mx-sm-6">
                                    ...
                                    <select class="form-control form-control-inline input-medium"
                                        ...
                                        <option value="adb-ptd-pwb">ADB/PTD/PWB</option>
                                    </select>
                                </div>
                            </div>
                            <br>
                ...
                <div class="alert"
                    ...
                    <p>
                        3. {{('Once you have downloaded and filled the skeleton file, upload it in the form and submit')}}
                        .</p>
                </div>
                <br>
            </div>
            <br>
            <hr>
            <form action="{{route('endowment.rate.adb.index')}}" method="get" class="form-inline">
                {!! csrf_field() !!}
                <div class="">
            ...
            <div class="mx-auto text-center">
                @if($selectedCompany)
                    ...
                    <br>
                    <label class=" mb-2">Selected Type: {{$type ? $type : 'N/A'}}</label>
                    <br>
                    <a href="{{ route('company.adb.rates.export',(['company_id'=>$selectedCompany->id, 'product_id'=>$selectedProduct->id])) }}"
                       download>
                        <button class="btn btn-info mr-2">Download ADB Rate Endowment</button>
                    </a>
                @endif
            </div>
            @if($columns && $rows)
                <div style="overflow-x:auto;">
                    ...
                    @include('RateTable.whole_adb.table')
                </div>
            @else

...
@section('title')
<p class="h4 align-center mb-0">Contact Page Settings</p>
@endsection
...
<div class="box">
    <div class="box-header with-border c-btn-right d-flex-row ">
        <div class="justify-content-end list-group list-group-horizontal ">
            <a href="{{route('general-setting.contact.create')}}"><button
                ...
                <tbody id="tablebody">
                    ...
                    <tr class="gradeX" id="row_{{ $setting->id }}">
                        ...
                        <td class="justify-content-center">
                            <a href="{{route('general-setting.contact.edit',$setting->id)}}" id="{{ $setting->id }}"
                                title="Edit">
                            ...
                            <a href="javascript:;" title="Delete" class="delete-contact-setting"
                                id="{{ $setting->id }}">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#tablebody').on('click', '.delete-contact-setting', function(e){
        e.preventDefault();
        $object = $(this);

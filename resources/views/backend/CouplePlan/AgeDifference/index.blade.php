...
@section('title')
<p class="h4 align-center mb-0">Age Difference in Couple Plan </p>
@endsection
...
<div class="box">
    <div class="box-header with-border c-btn-right d-flex-row ">
        <div class="justify-content-end list-group list-group-horizontal ">
            <a href="{{route('age-difference.create')}}"><button
                ...
                <tbody id="tablebody">
                    ...
                    <tr class="gradeX" id="row_{{ $ageDiff->id }}">
                        ...
                        <td class="justify-content-center">
                            <a href="{{route('age-difference.edit', $ageDiff->id)}}" id="{{ $ageDiff->id }}"
                                title="Edit">

...
@section('title')
<p class="h4 align-center mb-0">Users KYC Form</p>
@endsection
@section('footer_js')
...
<div class="box box-success">
    ...
    <div class="box-body">
        ...
        <div class="tab-content">
            <p class="text-center font-weight-bold">Your KYC No. : {{Auth::User()->kyc->KYCNO ?? ''}}</p>
            <form class="calc-from" id="calculationForm" action="{{route('user.kyc.entry')}}" method="POST">
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <select class="form-control" id="categoryListId" name="CATEGORYID" required>
                                ...
                                <option
                                    {{ Auth::user()->kyc && Auth::user()->kyc['CATEGORYID'] == $cat->ID ?'selected' :'' }}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <select class="form-control" id="INSUREDTYPEID" name="INSUREDTYPE" required>
                                ...
                                <option
                                    {{ Auth::user()->kyc && Auth::user()->kyc['INSUREDTYPE'] == $insType->INSUREDTYPEID ?'selected' :'' }}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <select class="form-control" id="kycclassificationID" name="kycclassification" required>
                                ...
                                <option
                                    {{ Auth::user()->kyc && Auth::user()->kyc['kycclassification'] == $kycCls->ID ?'selected' :'' }}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <select class="form-control" id="KYCRiskCategory" name="KYCRiskCategory" required>
                                ...
                                <option
                                    {{ Auth::user()->kyc && Auth::user()->kyc['KYCRiskCategory'] == $rskcat->ID ?'selected' :'' }}
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <input type="text" class="form-control" id="TITLE" placeholder="Enter Name in Full Name"
                                name="INSUREDNAME_ENG" value="{{ Auth::user()->kyc['INSUREDNAME_ENG']??'' }}">
                        </div>
                    </div>
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                            ...
                            <input type="text" class="form-control" id="INSUREDNAME_NEP"
                                ...
                                value="{{ Auth::user()->kyc['INSUREDNAME_NEP']??'' }}">
                </div>
        </div>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <select class="form-control" id="provinceId" name="ZONEID" required>
                    ...
                    <option
                        {{ Auth::user()->kyc && Auth::user()->kyc['ZONEID'] == $province->PROVINCECODE ?'selected' :'' }}
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control" id="ADDRESS" placeholder="Please enter address." name="ADDRESS"
                    value="{{Auth::user()->kyc['ADDRESS']??'' }}">
            </div>
        </div>
         ...
         <div class="form-group col-md-6">
            ...
            <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control" id="ADDRESSNEPALI" placeholder="Please enter address in nepali."
                    name="ADDRESSNEPALI" value="{{Auth::user()->kyc['ADDRESSNEPALI']??'' }}">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="number" class="form-control" id="WARDNO" placeholder="Please enter Ward no." name="WARDNO"
            value="{{ Auth::user()->kyc['WARDNO']??'' }}" required">
    </div>
</div>
...
<div class="form-group col-md-3">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="number" class="form-control" id="houseno" placeholder="Please enter house No." name="HOUSENO"
            value="{{ Auth::user()->kyc['HOUSENO']??'' }}">
    </div>
</div>
<div class="form-group col-md-3">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="number" class="form-control" id="plotno" placeholder="Please enter plot no."
            value="{{ Auth::user()->kyc['PLOTNO']??'' }}" name="PLOTNO">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="text" class="form-control" placeholder="Please enter temporary address."
            value="{{ Auth::user()->kyc['TEMPORARYADDRESS']??'' }}" name="TEMPORARYADDRESS">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="text" class="form-control" placeholder="Please enter temporary address in nepali."
            value="{{ Auth::user()->kyc['NTEMPORARYADDRESS']??'' }}" name="NTEMPORARYADDRESS">
</div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="tel" class="form-control" id="telno" placeholder="Please enter Telephone Number." name="HOMETELNO"
            value="{{ Auth::user()->kyc['HOMETELNO']??'' }}">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="tel" class="form-control" id="mbno" placeholder="Please enter Mobile Number." name="MOBILENO"
            value="{{ Auth::user()->kyc['MOBILENO']??'' }}">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="text" class="form-control" id="email" placeholder="Please enter email address."
            value="{{ Auth::user()->kyc['EMAIL']??'' }}" name="EMAIL">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <select class="form-control" id="occupation" name="OCCUPATION" required>
            ...
            <option {{ Auth::user()->kyc && Auth::user()->kyc['OCCUPATION'] == $occ->BUSSOCCPCODE ?'selected' :'' }}
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <select class="form-control" id="INCOMESOURCE" name="INCOMESOURCE" required>
            ...
            <option {{ Auth::user()->kyc && Auth::user()->kyc['INCOMESOURCE'] == $incSrc->ID ?'selected' :'' }}
...
<div class="form-group col-md-6">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="number" class="form-control" id="panno" placeholder="Please enter Pan Number."
            value="{{ Auth::user()->kyc['PANNO']??'' }}" name="PANNO">
    </div>
</div>
...
<div class="form-group col-md-4">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <select class="form-control" id="gender" name="GENDER" required>
            ...
            <option {{ Auth::user()->kyc && Auth::user()->kyc['GENDER'] == 1 ?'selected' :'' }} value="1">
                Male
            </option>
            <option {{ Auth::user()->kyc && Auth::user()->kyc['GENDER'] == 0 ?'selected' :'' }} value="0">
                Female
            </option>
            <option {{ Auth::user()->kyc && Auth::user()->kyc['GENDER'] == 2 ?'selected' :'' }} value="2">
                Other
            </option>
        </select>
    </div>
...
<div class="form-group col-md-4">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <select class="form-control" id="MARITALSTATUS" name="MARITALSTATUS" required>
            ...
            <option {{ Auth::user()->kyc && Auth::user()->kyc['MARITALSTATUS'] == 0 ?'selected' :'' }} value="0">
                Unmarried
            </option>
            <option {{ Auth::user()->kyc && Auth::user()->kyc['MARITALSTATUS'] == 1 ?'selected' :'' }} value="1">
                Married
            </option>
            <option {{ Auth::user()->kyc && Auth::user()->kyc['MARITALSTATUS'] == 2 ?'selected' :'' }} value="2">
                Divorced
            </option>
            <option {{ Auth::user()->kyc && Auth::user()->kyc['MARITALSTATUS'] == 3 ?'selected' :'' }} value="3">
                Widow
            </option>
        </select>
    </div>
...
<div class="form-group col-md-4">
    ...
    <div class="input-group">
        ...
        <input class="form-control" name="DATEOFBIRTH" data-date-format="yyyy-mm-dd" data-provide="datepicker"
            value="{{ Auth::user()->kyc['DATEOFBIRTH']??'' }}">
...
<div class="form-group col-md-4">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <input type="text" class="form-control" id="ctznno" placeholder="Please enter citizenship no."
            value="{{ Auth::user()->kyc['CITIZENSHIPNO']??'' }}" name="CITIZENSHIPNO">
    </div>
</div>
...
<div class="form-group col-md-4">
    ...
    <div class="input-group mb-2 mr-sm-2">
        ...
        <select class="form-control" id="ISSUE_DISTRICT_ID_LIST" name="ISSUE_DISTRICT_ID" required>
...
<div class="form-group col-md-4">
    ...
    <div class="input-group">
        ...
        <input class="form-control datepicker" data-date-format="yyyy-mm-dd" name="ISSUEDATE" data-provide="datepicker"
            value="{{ Auth::user()->kyc['ISSUEDATE']??'' }}">
        <span style="margin-left: -20px; z-index:999;" class="fa fa-calendar mt-2"></span>
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="FATHERNAME" placeholder="Please enter fathers name."
            value="{{ Auth::user()->kyc['FATHERNAME']??'' }}" name="FATHERNAME">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="MOTHERNAME" placeholder="Please enter mothers name."
            value="{{ Auth::user()->kyc['MOTHERNAME']??'' }}" name="MOTHERNAME">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="GRANDFATHERNAME" placeholder="Please enter Grand fathers name."
            value="{{ Auth::user()->kyc['GRANDFATHERNAME']??'' }}" name="GRANDFATHERNAME">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="GRANDMOTHERNAME" placeholder="Please enter Grand mothers name."
            value="{{ Auth::user()->kyc['GRANDMOTHERNAME']??'' }}" name="GRANDMOTHERNAME">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="HUSBANDNAME" placeholder="Please enter your husband name."
            value="{{ Auth::user()->kyc['HUSBANDNAME']??'' }}" name="HUSBANDNAME">
        <input type="hidden" class="form-control" name="NFATHERNAME" value="usersfather">
        <input type="hidden" class="form-control" name="NGRANDFATHERNAME" value="usergrandfather">
    </div>
</div>
...
<div class="form-group col-md-6">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" id="WIFENAME" placeholder="Please enter your wife name."
            value="{{ Auth::user()->kyc['WIFENAME']??'' }}" name="WIFENAME">
    </div>
</div>

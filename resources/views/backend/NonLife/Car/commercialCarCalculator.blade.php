...
@section('footer_js')
    ...
    <script type="text/javascript">
        ...
        $('.catId-list').on('change', function () {
            var CATEGORYID = $(this).val();

            $.ajax({
                type: "POST",
                url: "{{ route('nonLife.calculator.motor.category.type') }}",
                data: {
                    CATEGORYID: CATEGORYID,
                },
                dataType: 'json',
                success: function (response) {
                    // console.log(response.CategoryType.CALCTYPE);
                    var clTp = response.CategoryType.CALCTYPE;
                    $('.val-def').val('0');
                    $('.CalType1').addClass('d-none');
                    $('.CalType2').addClass('d-none');
                    $('.calType3').addClass('d-none');
                    if (clTp && clTp == 1 || clTp == 4) {
                        $('.CalType3').removeClass('d-none');
                    }
                    if (clTp && clTp == 2) {
                        $('.CalType1').removeClass('d-none');
                    }
                    if (clTp && clTp == 3 || clTp == 5) {
                        $('.CalType2').removeClass('d-none');
                    }
        ...
        $('.seat-calc').on('input', function () {
            var totalSeats =$('#totalSeats').val();
            var empNo =$('#NOOFEMPLOYEE').val();
            empNo ++;
            $('#NOOFPASSENGER').val(totalSeats - empNo);
        });
        $('.seat-calc1').on('input', function () {
            var totalSeats =$('#totalSeats1').val();
            var empNo =$('#NOOFEMPLOYEE1').val();
            empNo ++;
            $('#NOOFPASSENGER1').val(totalSeats - empNo);
        });
    </script>
@endsection
<style>
...
@section('dynamicdata')
    ...
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">Commercial Motor Calculation</h3>
        </div>
        <div class="box-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <select class="form-control excessCalculate excess-damage catId-list"
                                            id="categoryListId"
                                            name="CATEGORYID"
                                            required>
                            ...
                            <div class="form-group col-md-12 calType3 d-none">
                                <label class="sr-only" for="CC">Cubic Capacity (cc)</label>
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Cubic Capacity (cc) / KW</div>
                                    </div>
                                    <input type="number" class="form-control val-def" id="CCHP" min="0"
                                           placeholder="Motor Cubic Capacity e.g. 1500"
                                           name="CCHP"
                                           value="{{ $_GET['CCHP']??'0' }}">
                                </div>
                            </div>

                            <div class="form-group col-md-12 calType2 d-none">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control val-def" id="CARRYCAPACITY"
                            ...
                            <div class="form-group col-md-12 CalType1 d-none">
                                <label class="sr-only" for="inlineFormInputName2">Total Seats</label>
                                <div class="input-group mb-2 mr-sm-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">Total Seats</div>
                                    </div>
                                    <input type="number" class="form-control seat-calc val-def" id="totalSeats"
                                           placeholder="Please enter total number of seats." min="2"
                                           name="PASSCAPACITY" value="0">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control seat-calc" id="NOOFEMPLOYEE" min="0"
                            ...
                            <div class="form-group col-md-12 CalType1 d-none">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control seat-calc val-def" id="NOOFPASSENGER"
                                           placeholder="Please enter No. of Passengers." min="0"
                                           name="NOOFPASSENGER" value="0">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <select class="form-control excessCalculate catId-list"
                                            id="categoryListId"
                                            name="CATEGORYID"
                                            required>
                                        <option disabled="disabled" selected="selected">Select the Category</option>
                                        @foreach ($categories->data as $cat)
                                            <option value="{{ $cat->CATEGORYID }}">
                                                {{ $cat->CATEGORYNAME }}
                                            </option>
                            ...
                            <div class="form-group col-md-12 calType3 d-none">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control val-def" id="CCHP"
                                           placeholder="Motor Cubic Capacity e.g. 1200"
                                           name="CCHP" min="0"
                                           value="{{ $_GET['CCHP']??'0' }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12 CalType1 d-none">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control seat-calc1 val-def" id="totalSeats1"
                                           placeholder="Please enter total number of seats."
                                           name="PASSCAPACITY" value="0">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control seat-calc1" id="NOOFEMPLOYEE1" min="0"
                                           placeholder="Please enter No. of Employees."
                                           name="NOOFEMPLOYEE" value="{{ $_GET['NOOFEMPLOYEE']??'1' }}">
                                    <input type="text" class="form-control" id="PACONDUCTOR"
                                           placeholder="Please enter payble amount."
                            ...
                            <div class="form-group col-md-12 CalType1 d-none">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    ...
                                    <input type="number" class="form-control seat-calc1 val-def" id="NOOFPASSENGER1"
                                           placeholder="Please enter No. of Passengers."
                                           name="NOOFPASSENGER" value="0">
                                    <input type="text" class="form-control" id="PAPASSENGER"
                                           placeholder="Please enter payble amount."
                                           name="PAPASSENGER" value="500000" readonly>

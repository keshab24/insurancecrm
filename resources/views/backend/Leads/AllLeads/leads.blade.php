...
@section('footer_js')
    ...
    {{--            $('#leadLists tfoot th:gt(0)').each(function () {--}}
    {{--                var title = $(this).text();--}}
    {{--                $(this).html('<input type="text" placeholder="' + title + '" />');--}}
    {{--            });--}}

    {{--            // DataTable--}}
    {{--            var table = $('#leadLists').DataTable({--}}
    ...
    <script type="text/javascript">
        ...
        $(".edit-modal").on("click", function (e) {
            ...
            modal.find('.tab-pane #is_user').val(is_user);
        });
    </script>
        ...
        <div class="box-header with-border c-btn-right d-flex-row ">
            ...
            <div class="justify-content-end list-group list-group-horizontal ">
                <button class="btn btn-primary c-primary-btn add-modal shadow-none mx-2" data-toggle="modal"
                        data-target="#addModal"><img src="{{ asset('uploads/add-circle-16-Regular.svg') }}"
                                                     alt="Add-icon">
                    &nbsp;
                    Leads &nbsp;
                ...
                <div class="col-sm-6">
                    <form action="" enctype="multipart/form-data">
                        <div class="input-group rounded col-md-6">
                            <input type="search" name="search" class="form-control rounded" placeholder="Search Leads"
                                   aria-label="Search"
            ...
            <table id="leadLists" class="table table-bordered table-striped role-table leads-table">
                ...
                @foreach($leads as $lead)
                    <tr>
                        ...
                        <td>
{{--                            <button class="btn btn-primary btn-sm mr-2 action-btn" data-toggle="modal"--}}
{{--                                    data-target="#addNewUserModal"><img--}}
{{--                                    src="{{ asset('uploads/add-circle-16-Regular.svg') }}" alt="Add-icon"> Make User &nbsp;--}}
{{--                            </button>--}}
{{--                            <!-- Modal Start -->--}}
{{--                        @include('Backend.Leads.Leads.userAdd')--}}
{{--                        <!-- Modal End -->--}}
                            <button id="leadEdit" title="Edit Lead" class="btn btn-primary btn-sm edit-modal action-btn"
                                    data-lead_id="{{$lead->id}}" data-is_user="{{$lead->is_user}}"

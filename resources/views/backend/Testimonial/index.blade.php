...
@section('title')
    <p class="h4 align-center mb-0">Testimonials</p>
@endsection
@section('footer_js')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="justify-content-end list-group list-group-horizontal ">
                ...
                @include('Backend.Testimonial.add')
            </div>
            <br>
            <div class="blank-page">
                <table class="table" id="testimonialTable">
                    ...
                    @foreach($testimonials as $testimonial)
                        <tr class="gradeX" id="row_{{ $testimonial->id }}">
                            ...
                            <td>
                                ...
                                <a href="javascript:;" class="change-status ml-3"
                                   title="{{ $testimonial->status == 0 ? "Click to activate Testimonial." : "Click to De-active Testimonial." }}"
                                   id="{{ $testimonial->id }}">

...
@php
    $oldCompany = $bonusRate->company_id;
    $oldProduct = $bonusRate->product_id;
@endphp
...
@section('dynamicdata')
    ...
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">Edit Bonus Rate on Endowment Plan</h3>
        </div>
        <div class="box-body">
            @include('layouts.backend.alert')

            <form action="/bonusEdit/{{ $bonusRate->id }}" method="post">
                {!! csrf_field() !!}
                ...
                <div class="form-row">
                        ...
                        >
                            ...
                            @foreach ($companies as $company)
                                <option
                                    ...
                                    value="{{ $company->id }}"
                                    @if($bonusRate->company_id == $company->id) selected @endif
                                >
                                    {{ $company->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="form-group form-check col-12 col-md-6">
                        <input
                            ...
                            type="checkbox"
                            value="1"
                            @if($bonusRate->second_year == 2147483647) checked @endif
                        />

...
@section('title')
<p class="h4 align-center mb-0">Whole Life Plan Calculator</p>
@endsection
@section('footer_js')
...
<div class="box box-success">
  <div class="box-header">
    <h3 class="box-title">Whole Life Plan Calculation</h3>
  </div>
  <div class="box-body">
    ...
    <form class="form" action="{{ route('admin.wholelife.store') }}" method="post">
        @csrf    
          ...
          <div class="form-group col-12 col-md-6">
                      ...
                      <select class="form-control form-control input-medium search-select"
                          ...
                          @foreach ($companies as $company)
                              <option data-products="{{$company->whole_life_products()}}"
             ...
             <div class="form-group col-12 col-md-6">
              ...
              <input type="number" class="form-control" id="age" placeholder="age in year" name="age" value="{{ old('age') }}">
              </div>
                  </div>
              <div class="form-group col-12 col-md-6">
          ...
          <div class="input-group mb-2 mr-sm-2">
                  ...
                  <input type="number" class="form-control" id="term" placeholder="terms in year" name="term" value="{{ old('term') }}">
                </div>
              </div>
              ...
              <div class="form-group col-12 col-md-6">
                ...
                <div class="input-group mb-2 mr-sm-2">
                        ...
                        <input type="number" class="form-control" id="sum_assured" placeholder="Sum assure" name="sum_assured" value="{{ old('sum_assured') }}">
                      </div>
              </div>
      ...
      <label class="sr-only" for="inlineFormInputName2">Whole Life Plan Calculated</label>
      <div class="input-group mb-2 mr-sm-2">
              <div class="input-group-prepend">
                <div class="input-group-text">Whole Life Plan Calculated</div>
              </div>

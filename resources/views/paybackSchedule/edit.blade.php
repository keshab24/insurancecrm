...
<div class="box box-success">
    ...
    <div class="box-body">
        ...
        <form action="{{ route('admin.payback.update', $payback->id) }}" method="post">
            {!! csrf_field() !!}

            <div class="form-group">
                <p class="card-inside-title">Term Year:</p>
                <div class="form-line">
                    <input class="form-control form-control-inline input-medium" name="term_year" size="16" type="text"
                        placeholder="year" value="{{  $payback->term_year }}" />
                </div>
                <div class="form-group">
                    <p class="card-inside-title">Payback Year:</p>
                    <div class="form-line">
                        <input class="form-control form-control-inline input-medium" name="payback_year" size="16"
                            type="text" placeholder="year" value="{{  $payback->payback_year }}" />
                    </div>
                </div>
                <div class="form-group ">
                    <p class="card-inside-title">Rate</p>
                    <div class="form-line">
                        <input class="form-control form-control-inline input-medium" name="rate" size="16" type="text"
                            placeholder="rate" value="{{  $payback->rate }}" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-line">
                        <select class="form-control form-control-inline input-medium" name="company_id">
                            ...
                            <option value="{{ $company->id }}" @if($company->id == $payback->company_id) selected
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-line">
                                <select class="form-control form-control-inline input-medium" name="product_id">
                                    ...
                                    <option value="{{ $prod->id }}" @if($prod->id == $payback->product_id) selected

...
@endsection
@section('title')
<p class="h4 align-center mb-0">Payment Money Back Schedule</p>
@endsection
...
<div class="box">
    <div class="box-header with-border c-btn-right d-flex-row ">
        <div class="justify-content-end list-group list-group-horizontal ">
            <a href="{{route('admin.payback.create')}}">
  ...
  <div class="dataTables_wrapper dt-bootstrap4">
    ...
    <div class="box-body">
      ...
      <table id="example1" class="table table-bordered table-hover role-table">
        ...
        <tbody id="tablebody">
           @foreach($payback as $index=>$pay)
          <tr class="gradeX" id="row_{{ $pay->id }}">
            <td class="index">
              {{ ++$index }}
            </td>
            <td class="name">
            ...
            <td class="justify-content-center">
                <a href="paybackSchedule/edit/{{$pay->id}}" id="{{ $pay->id }}"
                title="Edit "><button class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></button></a>&nbsp;
                <a href='paybackSchedule/delete/{{ $pay->id }}' class="delete-discount" onclick="return confirm('Are you sure you want to Delete?');">
                <button

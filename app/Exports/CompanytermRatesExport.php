...
class CompanytermRatesExport implements FromView
{
    /**
...
//        dd($this->export);
        ...
        $data['rateEndowments'] = Term_rider::where('company_id', $this->export['company_id'])
        ...
        return view('RateTable.term_rider.extract-table', [
            'rows' => $rows,
            'columns' => $columns,

...
class CompanypwbRatesExport implements FromView
{
    /**
...
//        dd($this->export);
        ...
        $data['rateEndowments'] = Pwb_rate::where('company_id', $this->export['company_id'])
        ...
        return view('RateTable.pwb_rate.extract-table', [
            'rows' => $rows,
            'columns' => $columns,
